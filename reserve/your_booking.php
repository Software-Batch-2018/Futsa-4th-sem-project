<! -- This is inlcudes/required databases and links -->
  <html>
   ...
   $id = $_SESSION['id'];
   $sql_booking = "select futsal_name,date, book_time, booking_id, status from booking as b inner join user as u on b.booker_id = u.id inner join book_time as bt on b.book_time_id = bt.book_time_id inner join futsal as f on b.futsal_id = f.futsal_id where u.id = '$id' order by booking_id desc";
   ...
   <section>
        <div class="first-section-user">
            <div class="user-name">
                ...
                <p>Below is your booking status and history.<br></p>
            </div>
        </div>
    </section>
     ...
     <section class="wrap-table">
       <table>
           <tr class="head-wrap">
             <th class ="table-head">Futsal Name</th>
